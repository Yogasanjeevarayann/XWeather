...
val blaze=Color(0xFFFF6F00)
val chrome=Color(0xFFFFAB00)
val arlequin=Color(0xFF64DD17)
val amazonite=Color(0xFF00BFA5)
val turquoise=Color(0xFF00BCD4)
val azure=Color(0xFF009DFF)
val crayola=Color(0xFF2979FF)
...
object TailwindCSSColor {
    ...
    // colors.amber
    val Yellow300 = Color(0xFFF5D60B)
    val Yellow400 = Color(0xFFF5BB0B)
    ...
    // Colors for branding
    val GreenPrimary = Color(0xFF4CAF50) // Example green for primary color
    val GreenSecondary = Color(0xFF388E3C) // Slightly darker green
    val GreenTertiary = Color(0xFFC8E6C9) // Light green for tertiary

    // Additional shades (optional)
    val GreenBackground = Color(0xFFE8F5E9) // Very light green for backgrounds
    val GreenSurface = Color(0xFFA5D6A7) // Muted green for surfaces
}

object Leaderboard {
    // Primary Colors
    val LightGreen = Color(0xFFB7D08E) // Pastel green tone
    val SoftOrange = Color(0xFFF9CA86) // Light pastel orange tone
    val BrightBlue = Color(0xFF42A5F5) // Bright blue
    val CoralRed = Color(0xFFFF5252)   // Bright coral red

    // Complementary Colors
    val SoftYellow = Color(0xFFFFF7A3) // Soft yellow tone
    val WarmPink = Color(0xFFF6A5C0)   // Warm pink tone
    val Lavender = Color(0xFFE1BEE7)   // Soft lavender tone
    val SkyBlue = Color(0xFF81D4FA)    // Light sky blue tone

    // Neutral Colors
    val CoolGray = Color(0xFFB0BEC5)   // Neutral cool gray
    val LightWhite = Color(0xFFF5F5F5) // Very light neutral white-gray tone
    val CharcoalGray = Color(0xFF455A64) // Deep charcoal gray
    val Ivory = Color(0xFFFFF8E1)      // Soft ivory tone

    // Accent Colors
    val DeepTeal = Color(0xFF004D40)   // Deep teal accent
    val VibrantRed = Color(0xFFE57373) // Vibrant red accent
    val AmberGlow = Color(0xFFFFC107)  // Bright amber glow
    val LimeGreen = Color(0xFFCDDC39)  // Vibrant lime green accent

    // Earthy Tones
    val OliveGrove = Color(0xFF606E55) // Olive green
    val SageGreen = Color(0xFFB7D08E)  // Sage green
    val RustyClay = Color(0xFFA8593E)  // Rusty clay tone
    val SandyBeige = Color(0xFFD2B48C) // Sandy beige tone

    // Cool Tones
    val ArcticBlue = Color(0xFFB3E5FC) // Arctic light blue
    val MidnightBlue = Color(0xFF1A237E) // Deep midnight blue
    val FrostWhite = Color(0xFFF8FAFC) // Frosty white

    // Warm Tones
    val SunsetOrange = Color(0xFFFF7043) // Sunset orange
    val GoldenSun = Color(0xFFFFD54F)    // Golden sun
    val RedClay = Color(0xFFD84315)      // Red clay tone
    val BlushPink = Color(0xFFFFC1E3)    // Soft blush pink

    // Metallic Tones
    val Gold = Color(0xFFFFD700)        // Gold
    val Silver = Color(0xFFC0C0C0)      // Silver
    val Bronze = Color(0xFFCD7F32)      // Bronze
    val SteelBlue = Color(0xFF4682B4)   // Steel blue tone

    // Additional Highlights
    val SunlitApricot = Color(0xFFF9CA86) // Sunlit apricot
    val OceanBlue = Color(0xFF0277BD)    // Deep ocean blue
    val ForestGreen = Color(0xFF2E7D32)  // Forest green
    val RoseRed = Color(0xFFC2185B)      // Rose red
}
